...
export default function PatientDashboard() {
      ...
      try {
        ...
        const appRes = await fetch(`${apiUrl}/api/appointments/patient`, {
          ...
          headers: {
            ...
            localStorage.getItem("medico_auth_token")
              ? {
                  Authorization:
                    "Bearer " + localStorage.getItem("medico_auth_token"),
                }
              : {}),
          },
        });
  ...
  const handleAiDiagnose = async (e) => {
    ...
    try {
      ...
      const authHeader =
        ...
        localStorage.getItem("medico_auth_token")
          ? {
              Authorization: `Bearer ${localStorage.getItem("medico_auth_token")}`,
            }
          : {};
      ...
      const response = await fetch(`${apiUrl}/api/ai/diagnose`, {
        ...
        body: JSON.stringify({ symptoms: symptomsInput.trim() }),
      });
  ...
  const upcomingAppointments = appointments.filter(
    (app) =>
      ...
      ["pending", "accepted"].includes(app.appointmentStatus),
  );
    ...
    <div className="space-y-8 text-left">
      <div>
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400">
          Track and schedule your healthcare consultations.
        </p>
      </div>
          ...
          <div className="flex items-center space-x-2 border-b border-slate-100 dark:border-slate-800 pb-3">
            ...
            <div>
              <h2 className="text-base font-bold text-slate-900 dark:text-white">
                Medico AI Symptom Assistant
              </h2>
              <p className="text-[10px] text-slate-400 font-medium">
                Powered by Gemini - Instant specialist recommendation
              </p>
            </div>
          </div>
            ...
            <div className="border border-purple-100 dark:border-purple-900/40 bg-purple-50/20 dark:bg-purple-950/10 rounded-2xl p-5 space-y-4 animate-fade-in text-sm">
              ...
              <div className="pt-2">
                ...
                >
                  <span>
                    Book a{" "}
                    {aiDiagnosis.specialization === "General"
                      ? "General Physician"
                      : aiDiagnosis.specialization}{" "}
                    Doctor
                  </span>
              ...
              <div className="flex items-center space-x-3 text-left">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400">
                    Search specialized practitioners
                  </p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center space-x-3 text-left">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400">
                    Reschedule or pay consultation fee
                  </p>
                </div>
              </div>
              <FiChevronRight className="text-slate-400" />
